...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_left', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'241222063048'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640,480,6', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640,480,6', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '640,480,6', 'description': 'infra streams (0/1/2) profile'},
