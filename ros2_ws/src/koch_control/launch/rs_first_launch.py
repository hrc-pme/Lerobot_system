...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_first', 'description': 'camera unique name'},
                           ...
                           {'name': 'serial_no',                    'default': "'319522065801'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'depth_module.infra_profile',   'default': '1280,720,30', 'description': 'infra streams (0/1/2) profile'},
