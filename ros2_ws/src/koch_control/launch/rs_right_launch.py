...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_right', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'241222061342'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640x480x6', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640x480x6', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '640x480x6', 'description': 'infra streams (0/1/2) profile'},
