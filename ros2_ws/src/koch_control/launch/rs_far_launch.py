...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera_far', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'327322061107'", 'description': 'choose device by serial number'},
