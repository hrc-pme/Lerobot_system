#!/bin/bash
# ===================================================================
# Docker Run Script for lerobot_system with CPU only + GUI + UID fix
# ===================================================================
...
TAG="humble"
CONTAINER_NAME="lerobot_system-cpu-container"
...
echo -e "${BLUE}======================================${NC}"
echo -e "${BLUE}Running lerobot_system Container with CPU Only${NC}"
echo -e "${BLUE}======================================${NC}"
...
docker run -it \
  ...
  /bin/bash -lc "
    ...
    echo '========================================'
    echo 'lerobot_system Development Container (CPU Only)'
    echo '========================================'
